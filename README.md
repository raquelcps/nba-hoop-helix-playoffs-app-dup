...
Like many first projects, it contained ideas I still love alongside implementation decisions that make me laugh today.

Revisiting it has been an enjoyable reminder of how much I've grown as an engineer. Instead of starting from scratch, I chose to rebuild and refactor the application while preserving the original curiosity that inspired it.
...
* Team and player pages built from NBA Stats API data
* Playoff round exploration
* Contextual player rankings within a team
* Player contribution metrics expressed as percentages of team production
* Visual contribution components designed to make statistical relationships easier to understand
...
Rather than persisting large amounts of statistical data in a local database, Hoop Helix retrieves live data from the API while caching responses to improve performance and reduce unnecessary requests. I chose this approach because I wanted to better understand the API itself and explore how it might support future features.

As the project has evolved, I've continued refactoring the original architecture to better separate responsibilities.

Current architectural improvements include:

* Service objects for external API communication and data normalization
* Shared helper methods for reusable contribution calculations
* Reusable view components for player and team statistics
* Progressive reduction of duplicated business logic

This work is ongoing. Planned improvements include:

* Thorough automated test coverage
* Continued architectural refactoring
* SCSS cleanup and organization
...
The application currently explores those relationships through visual components such as:

* Team contribution distributions
* Player contribution comparisons
* Contextual team rankings
* Playoff progression and opponent context

Some visualizations are intentionally simple. Others will become more exploratory over time.
...
* Additional ways to compare player contributions
